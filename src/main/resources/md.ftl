...
------ | ----------- | ------------| ------ | ----------- | ------------|
Sword | <#if unit.oldValues["baseSwordLv"]??>${unit.oldValues["baseSwordLv"].amount} → **${unit.baseSwordLv.amount}**<#else>${unit.baseSwordLv.amount}</#if> | ${unit.baseSwordLv.name} | Fire | <#if unit.oldValues["baseFireLv"]??>${unit.oldValues["baseFireLv"].amount} → **${unit.baseFireLv.amount}**<#else>${unit.baseFireLv.amount}</#if> | ${unit.baseFireLv.name} |
Lance | <#if unit.oldValues["baseLanceLv"]??>${unit.oldValues["baseLanceLv"].amount} → **${unit.baseLanceLv.amount}**<#else>${unit.baseLanceLv.amount}</#if> | ${unit.baseLanceLv.name} | Thunder | <#if unit.oldValues["baseThunderLv"]??>${unit.oldValues["baseThunderLv"].amount} → **${unit.baseThunderLv.amount}**<#else>${unit.baseThunderLv.amount}</#if> | ${unit.baseThunderLv.name} |
Axe | <#if unit.oldValues["baseAxeLv"]??>${unit.oldValues["baseAxeLv"].amount} → **${unit.baseAxeLv.amount}**<#else>${unit.baseAxeLv.amount}</#if> | ${unit.baseAxeLv.name} | Wind | <#if unit.oldValues["baseWindLv"]??>${unit.oldValues["baseWindLv"].amount} → **${unit.baseWindLv.amount}**<#else>${unit.baseWindLv.amount}</#if> | ${unit.baseWindLv.name} |
Bow | <#if unit.oldValues["baseBowLv"]??>${unit.oldValues["baseBowLv"].amount} → **${unit.baseBowLv.amount}**<#else>${unit.baseBowLv.amount}</#if> | ${unit.baseBowLv.name} | Light | <#if unit.oldValues["baseLightLv"]??>${unit.oldValues["baseLightLv"].amount} → **${unit.baseLightLv.amount}**<#else>${unit.baseLightLv.amount}</#if> | ${unit.baseLightLv.name} |
Staff | <#if unit.oldValues["baseStaffLv"]??>${unit.oldValues["baseStaffLv"].amount} → **${unit.baseStaffLv.amount}**<#else>${unit.baseStaffLv.amount}</#if> | ${unit.baseStaffLv.name} | Dark | <#if unit.oldValues["baseDarkLv"]??>${unit.oldValues["baseDarkLv"].amount} → **${unit.baseDarkLv.amount}**<#else>${unit.baseDarkLv.amount}</#if> | ${unit.baseDarkLv.name} |
