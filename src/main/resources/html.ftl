...
<html lang="en">
	...
	<body>
		...
		<tr>
			<td>
				<#if unit.oldValues["skills1"]??>
				<i>${unit.oldValues["skills1"]?string.@hex_2}</i> -> <i><b>${unit.skills1?string.@hex_2}</b></i>
				<#else>
				<i>${unit.skills1?string.@hex_2}</i>
				</#if>
			</td>
			<td>
				<#if unit.oldValues["skills2"]??>
				<i>${unit.oldValues["skills2"]?string.@hex_2}</i> -> <i><b>${unit.skills2?string.@hex_2}</b></i>
				<#else>
				<i>${unit.skills2?string.@hex_2}</i>
				</#if>
			</td>
			<td>
				<#if unit.oldValues["skills3"]??>
				<i>${unit.oldValues["skills3"]?string.@hex_2}</i> -> <i><b>${unit.skills3?string.@hex_2}</b></i>
				<#else>
				<i>${unit.skills3?string.@hex_2}</i>
				</#if>
			</td>
		</tr>
		</table>
		...
		<p>
			...
			<b><#list unit.skills as skill>${skill.getName()}<#sep>, </#list></b>
			<#else>
		...
		<table>
			...
			<tr>
				...
				<td>
					<#if item.oldValues["skills1"]?? || item.oldValues["skills2"]??>
					<b><#list item.skills as skill>${skill.getName()}<#sep>, </#list></b>
					<#else>
					<#list item.skills as skill>${skill.getName()}<#sep>, </#list>
					</#if>
				</td>
				<td>
		...
		<table>
			...
			<tr>
				<td>
					<#if shop.modified>
					<b>${item.getName()} ${item.totalCost}</b>
					<#else>
					${item.getName()} ${item.totalCost}
					</#if>
				</td>
			</tr>
			</#list>
		...
		<ul>
			...
			<li><b>${item.getName()}(${item.offset?string.@hex_2})</b></li>
			<#else>
			<li><i><b>Empty</b></i></li>
			</#list>
		</ul>
		...
		<ul>
			<#list unit.inventory as item>
			<li>${item.getName()}(${item.offset?string.@hex_2})</li>
			<#else>
			<li><i>Empty</i></li>
			</#list>
		</ul>
