...
public enum CharacterClass {
    ...
    MAGE_KNIGHT_F_DISMOUNTED(0x67, "Mage Knight (F) (dismounted)", 0x2D),
    ...
    private static final ArrayList<CharacterClass> HEALERS = new ArrayList<>(List.of(
            ...
            DARK_MAGE));
    private static final ArrayList<CharacterClass> UNPROMOTED = new ArrayList<>(List.of(SOCIAL_KNIGHT, LANCE_KNIGHT,
            ARCH_KNIGHT, AXE_KNIGHT, FREE_KNIGHT, TROUBADOUR, PEGASUS_KNIGHT, DRAGON_RIDER, DRAGON_KNIGHT, BOW_FIGHTER,
            SWORD_FIGHTER, FORREST, LANCE_ARMOR, AXE_ARMOR, BOW_ARMOR, SWORD_ARMOR, MOUNTAIN_THIEF, MOUNTAIN_THIEF2,
            ...
            AXE_KNIGHT_DISMOUNTED, FREE_KNIGHT_DISMOUNTED, TROUBADOUR_DISMOUNTED, PEGASUS_KNIGHT_DISMOUNTED,
            DRAGON_RIDER_DISMOUNTED, DRAGON_KNIGHT_DISMOUNTED, ARCH_KNIGHT_F, ARCH_KNIGHT_F_DISMOUNTED, DRAGON_RIDER_F,
            DRAGON_RIDER_F_DISMOUNTED, DRAGON_KNIGHT_F, DRAGON_KNIGHT_F_DISMOUNTED, MAGE_F, THUNDER_MAGE_F,
            LOPTO_MAGE_F, WIND_MAGE_F, PRIEST_F, SWORD_FIGHTER_F, BOW_FIGHTER_F, THIEF_F, MERCENARY, PEGASUS_RIDER,
            PEGASUS_RIDER_DISMOUNTED, SOLDIER, ARCHER, MERCENARY_F));
    private static final ArrayList<CharacterClass> PROMOTED = new ArrayList<>(List.of(PALADIN, PALADIN_F,
            FORREST_KNIGHT, BOW_KNIGHT, MAGE_KNIGHT, GREAT_KNIGHT, FALCON_KNIGHT, DRAGON_MASTER, SWORDMASTER, SNIPER,
            FORREST, GENERAL, EMPEROR, BARON, BERSERKER, WARRIOR, MAGE_KNIGHT2, PRINCE, MAGE_KNIGHT_F, HIGH_PRIEST,
            BISHOP, SAGE, DARK_MAGE, DARK_BISHOP, THIEF_FIGHTER, DUKE_KNIGHT, DUKE_KNIGHT_DISMOUNTED,
    ...
    private static final ArrayList<CharacterClass> UNUSED_PROMOTED = new ArrayList<>(List.of(
            LORD_KNIGHT, MASTER_KNIGHT, GENERAL, EMPEROR, JUNIOR_LORD, KILLER_ARCH,
    ...
    private static final ArrayList<CharacterClass> FLYING = new ArrayList<>(
            List.of(DRAGON_KNIGHT, PEGASUS_KNIGHT, DRAGON_MASTER, DRAGON_KNIGHT_F, DRAGON_RIDER_F, FALCON_KNIGHT,
