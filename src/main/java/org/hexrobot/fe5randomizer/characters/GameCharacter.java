...
public enum GameCharacter {
    ...
    private static final ArrayList<GameCharacter> ENEMY_UNITS = new ArrayList<>(List.of(
            ...
            BALDACK_BOSS, THRACIA_LANCE_ARMOR, LENSTER_LANCE_KNIGHT, LENSTER_ARCH_KNIGHT, MAKROI_BOSS, KODDA_BOSS,
            ROPUTO_DARK_MAGE, THIEF, MANSTER_SNIPER, MERCENARY_SOCIAL_KNIGHT, PRIEST, MERCENARY_SWORD_FIGHTER2,
            CH21_IRON_ARCH, SHUPEL_BOSS, BLUKE_BOSS, SILESIA_PEGASUS_RIDER, NIKOLAF_BOSS, MUUA_BOSS, MYURA_BOSS,
            REINCOCK_BOSS, PALMAN_BOSS, KANTO_BOSS, GUSTAF_BOSS, DANCER, SISTER, MANHEIM_BOSS, PHLAUS_BOSS,
            ...
            FREEGE_MAGE_KNIGHT2, FREEGE_AXE_KNIGHT, FREEGE_BOW_KNIGHT2, FREEGE_PALADIN2, FREEGE_LANCE_KNIGHT,
            FREEGE_SNIPER, FREEGE_MERCENARY, FREEGE_BISHOP2, FREEGE_TROUBADOUR3, FREEGE_MAGE_KNIGHT,
            ALSTER_SOCIALKNIGHT2, ALSTER_ARCH_KNIGHT, ALSTER_BOW_KNIGHT, ALSTER_MAGE_KNIGHT, FREEGE_PRIEST,
            FREEGE_BOW_KNIGHT, FREEGE_PALADIN, FREEGE_SWORD_ARMOR, FREEGE_ARCH_KNIGHT, GELB_RITTER, FREEGE_GENERAL,
