...
public enum GameCharacter {
    ...
    CORPLE_NPC(0x0044, "Corple"),
    SETY_CH4X(0x0045, "Sety Ch4x"),
    ISHTAR(0x0046, "Ishtar"),
    REINHART_WEAK_VERSION(0x0047, "Reinhart (Weak version)"),
    ...
    YURIUS_YURIA_PORTRAIT(0x00AD, "Yurius (Yuria portrait...)"),
    MANFROY_MACHYUA_PORTRAIT(0x00AE, "Manfroy (Machyua portrait...)"),
    ...
    private static final ArrayList<GameCharacter> PLAYABLE_UNITS = new ArrayList<>(List.of(
            ...
            OLWEN, RIFIS, KARIN, DEAN, SHANAM, TREWD, TANYA, LINOAN, MISHA, SEIRAM, SLEUF, MAREETA, TINA,
            AMALDA, CONOMORE, HOMEROS, DELMUD, SARA, EYRIOS, XAVIER));
    private static final ArrayList<GameCharacter> ENEMY_UNITS = new ArrayList<>(List.of(
            ...
            RIFIS_GANG_WARRIOR, ROBOS, MANSTER_BOW_ARMOR, MANSTER_THUNDER_MAGE, MANSTER_BISHOP, CYAS,
            ...
            BANDIT_BERSERKER, MERCENARY_SWORD_FIGHTER4, DRAGON_RIDER, BISHOP, TOBOLZARK_BOSS, MANSTER_BISHOP2,
            ...
            LENSTER_SOLDIER, BARRAT_BOSS, FREEGE_GENERAL1, FREEGE_SWORD_ARMOR2, FREEGE_PRIEST2, FREEGE_POISON_ARCH,
            THRACIA_DRAGON_KNIGHT2, FREEGE_MAGE_KNIGHT2, FREEGE_AXE_KNIGHT, FREEGE_BOW_KNIGHT2, FREEGE_PALADIN2,
            FREEGE_LANCE_KNIGHT, FREEGE_SNIPER, FREEGE_MERCENARY, FREEGE_BISHOP2,
            ...
            MANSTER_GREAT_KNIGHT, THRACIA_DRAGON_KNIGHT3, MERCENARY, MERCENARY3, MERCENARY4, SNIPER, EINS, DREI_DAGDA,
            ...
            ALSTER_SOCIALKNIGHT, PIRATE, MANSTER_GENERAL, LOPTO_DARK_MAGE, THRACIA_SWORD_ARMOR, WOLF_BOSS));
    private static final ArrayList<GameCharacter> ALLY_UNITS = new ArrayList<>(List.of(MAGI_SQUAD_AXE_FIGHTER,
            MAGI_SQUAD_BOW_FIGHTER, MAGI_SQUAD_SWORD_FIGHTER, MAGI_SQUAD_SWORD_FIGHTER, LENSTER_LANCE_KNIGHT,
            LENSTER_ARCH_KNIGHT, RESISTANCE_BOW_FIGHTER, RESISTANCE_PRIEST, RESISTANCE_AXE_FIGHTER,
            RESISTANCE_BOW_FIGHTER2, RESISTANCE_SWORD_FIGHTER, RESISTANCE_SWORD_FIGHTER1, RESISTANCE_MAGE));
    private static final ArrayList<GameCharacter> BOSSES = new ArrayList<>(List.of(
            ...
            BARRAT_BOSS, EINS, DREI_DAGDA, DREI, ELF_SARA, ELF, ZWEI_GALZUS, ZWEI, ZWOLF_LIFIS, ZWOLF, FUNF_EYVEL,
    ...
    private static final ArrayList<GameCharacter> ZOMBIE_UNITS = new ArrayList<>(List.of(EINS, DREI_DAGDA, ELF_SARA,
            ZWEI_GALZUS, ZWOLF_LIFIS, FUNF_EYVEL));
    ...
    public boolean isAllyUnit() {
        return ALLY_UNITS.contains(this);
    }
    ...
    public static ArrayList<GameCharacter> getAllyUnits() {
        return new ArrayList<GameCharacter>(ALLY_UNITS);
    }
    ...
    public static List<GameCharacter> getZombieUnits() {
        return new ArrayList<>(ZOMBIE_UNITS);
    }
