...
public enum GameCharacter {
    ...
    private static final ArrayList<GameCharacter> ENEMY_UNITS = new ArrayList<>(List.of(
            ...
            DREI, ELF_SARA, ELF, ZWEI_GALZUS, ZWEI, ZWÖLF_LIFIS, ZWÖLF, FÜNF_EYVEL, FÜNF, LOPTO_DARK_MAGE2,
    ...
    private static final ArrayList<GameCharacter> BOSSES = new ArrayList<>(List.of(
            ...
            BARRAT_BOSS, EINS, DREI_DAGUDAR, DREI, ELF_SARA, ELF, ZWEI_GALZUS, ZWEI, ZWÖLF_LIFIS, ZWÖLF, FÜNF_EYVEL,
            FÜNF, LEIDRICK_2, WOLF_BOSS));
